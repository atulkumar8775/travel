	...
	<div class="header" id='topheader'>
	 <nav class="navbar navbar-expand-lg fixed-top">
      <div class="container text-uppercase p-2">
        ...
        <a class="navbar-brand font-weight-bold text-white" href="#">Atul travels</a>
  ...
  <div class="container">
    <div class="row">
      <div class='extra-div col-lg-4 col-md-4 col-12'>
        ...
        <h2>EASY TO USE</h2>
        <p>web development is easy to learn and make a awesome webpage.</p>
      </div>
...
<section class="Serviceoffers" id='servicediv'>
  ...
  <div class="container">
      <div class="row">
        <div class="col-lg-6 col-12 col-10 offset-1 offset-lg-0">
          <div class="name my-3">
            <h1>HTML</h1>
            <div class="progress w-75">
              <div class="progress-bar progress-bar-striped active" role="progressbar"
              aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:80%">80%</div>
            </div>
          </div>
          ...
          <div class="name my-3">
            ...
            <div class="progress w-75">
              <div class="progress-bar progress-bar-striped active" role="progressbar"
              aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:70%">70%</div>
            </div>
          </div>
          ...
          <div class="name my-3">
            ...
            <div class="progress w-75">
              <div class="progress-bar progress-bar-striped active" role="progressbar"
              aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:78%">78%</div>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-md-12 col-12 servicediv">
          <div class="row">
            ...
            <div class="col-lg-10 col-10">
              ...
              <p>We offer most and attractive price for you. hurry up</p>
            </div>
          </div>
...
<section class="pricing" id='pricediv'>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 col-12 second-card">
        <div class="card text-center">
